...
_PRIMARY_QUERY = text("SELECT * FROM feature.segmentation WHERE user_id = :uid LIMIT 1")

_FALLBACK_QUERY = text(
    """
    SELECT c.user_id, r.rfm_score, r.rfm_segment,
...
class SegmentationFeatureRepositoryImpl:
